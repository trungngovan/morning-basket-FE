        ...
        <div className="w-full max-w-[1000px] my-8 mx-auto py-8 px-4">
            ...
            <ul className="list-disc list-inside ml-4 leading-10">
                ...
                <li>
                    ...
                    Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                    &quot;Our&quot; in this Agreement) refers to Morning Basket,
                ...
                <li>
                    <strong>Website</strong> refers to Morning Basket,
                    accessible from{' '}
                    <a
                        href="morningbasket.vn"
            ...
            <ul className="list-disc list-inside ml-4 leading-10">
                <li>By email: hanorder@parkltd.net</li>
                <li>
                ...
                <li>By phone number: (+84) 93 864 28 87</li>
            </ul>
        </div>
    )
}
