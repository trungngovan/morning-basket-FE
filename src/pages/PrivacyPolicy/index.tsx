...
const PrivacyPolicyPage: React.FC = () => {
    return (
        <div className='w-full max-w-[1000px] my-8 mx-auto py-8 px-4'>
            <h1 className='text-4xl font-bold my-8'>Privacy Policy</h1>
            ...
            <h1 className='text-4xl font-bold my-8'>Interpretation and Definitions</h1>
            <h2 className='text-3xl font-bold my-4'>Interpretation</h2>
            <p>The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>
            <h2 className='text-3xl font-bold my-4'>Definitions</h2>
            <p>For the purposes of this Privacy Policy:</p>
            <ul className='list-disc list-inside ml-4 leading-10'>
                <li>
                ...
                <li>
                    <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Morning Basket, B1F-10, Crescent Mall, Quận 7, Thành phố Hồ Chí Minh.
                </li>
                <li>
                ...
                <li>
                    <strong>Website</strong> refers to Morning Basket, accessible from <a href="morningbasket.vn" rel="external nofollow noopener" target="_blank">morningbasket.vn</a>
                </li>
                <li>
                    <strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.
                </li>
            </ul>
            <h1 className='text-4xl font-bold my-8'>Collecting and Using Your Personal Data</h1>
            <h2 className='text-3xl font-bold my-4'>Types of Data Collected</h2>
            ...
            <h3 className='text-2xl font-bold my-4'>Usage Data</h3>
            ...
            <h3 className='text-2xl font-bold my-4'>Tracking Technologies and Cookies</h3>
            ...
            <h2 className='text-3xl font-bold my-4'>Use of Your Personal Data</h2>
            ...
            <h2 className='text-3xl font-bold my-4'>Retention of Your Personal Data</h2>
            ...
            <h2 className='text-3xl font-bold my-4'>Transfer of Your Personal Data</h2>
            ...
            <h2 className='text-3xl font-bold my-4'>Delete Your Personal Data</h2>
            ...
            <h2 className='text-3xl font-bold my-4'>Disclosure of Your Personal Data</h2>
            <h3 className='text-2xl font-bold my-4'>Business Transactions</h3>
            <p>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>
            <h3 className='text-2xl font-bold my-4'>Law enforcement</h3>
            <p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
            <h3 className='text-2xl font-bold my-4'>Other legal requirements</h3>
            ...
            <h2 className='text-3xl font-bold my-4'>Security of Your Personal Data</h2>
            ...
            <h1 className='text-4xl font-bold my-8'>Links to Other Websites</h1>
            <p>Our Service may contain links to other websites that are not operated by Us. If You click on a third party link, You will be directed to that third party's site. We strongly advise You to review the Privacy Policy of every site You visit.</p>
            <p>We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services.</p>
            <h1 className='text-4xl font-bold my-8'>Changes to this Privacy Policy</h1>
            ...
            <ul className='list-disc list-inside ml-4 leading-10'>
                <li>
                    By email:  hanorder@parkltd.net
                </li>
                <li>
                    By visiting this page on our website: <a href="https://morningbasket.vn/contact" rel="external nofollow noopener" target="_blank">https://morningbasket.vn/contact</a>
                </li>
                <li>
                    By phone number: (+84) 93 864 28 87
                </li>
            </ul>
        </div>
    )
